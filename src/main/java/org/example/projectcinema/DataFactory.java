...
public class DataFactory implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (!cinemaRepository.findAll().isEmpty()) {
            log.info("Data already exists in collections repository, skipping seed");
            return;
        }

        log.info("Starting data seeding for collections profile...");
        seedData();
        log.info("Data seeding completed successfully for collections profile");
    }
    ...
    private void seedData() {
        ...
        log.info("Created {} cinema screens", 4);
        ...
        log.info("Linked movies to screens");
        ...
        log.info("Linked movies to cinemas");
        ...
        log.info("All relationships persisted successfully");
    }
}